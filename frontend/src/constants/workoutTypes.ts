...
export const WORKOUT_TYPE_OPTIONS: WorkoutTypeOption[] = [
  {
    ...
    placeholder: 'mm:ss (np. 12:45)',
    hint: 'Wpisz czas w formacie: mm:ss lub hh:mm:ss',
    sortDirection: 'asc',
    resultUnit: 'time',
  },
  {
    ...
    placeholder: 'Rundy (np. 5)',
    hint: 'Wpisz liczbę ukończonych rund',
    sortDirection: 'desc',
    resultUnit: 'rounds',
  },
  {
  ...
  },
  {
    ...
    placeholder: 'Powtórzenia (np. 120)',
  ...
  },
  {
    ...
    placeholder: 'Ciężar (np. 100)',
    hint: 'Wpisz ciężar w kg lub lbs',
    sortDirection: 'desc',
    resultUnit: 'weight',
  },
  {
    ...
    hint: 'Wpisz wynik w dowolnym formacie',
    sortDirection: 'desc',
    resultUnit: 'custom',
  },
];
